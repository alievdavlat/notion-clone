...
const TrashBox = () => {
  ...
  const documents = useQuery(api.docuement.getTrashDocuments);
  const remove = useMutation(api.docuement.remove);
  const restore = useMutation(api.docuement.restore);

  const allDocuments = useQuery(api.docuement.getAllDocuments);
